...
def split_train_val_test():
    ...
    waste_types = ['cardboard','glass','electrical_cables','electronic_chips','laptops','small_appliances','smartphones','gloves','masks','medicines','syringe','beverage_cans','construction_scrap','metal_containers','other_metal_objects','spray_cans','newspaper','paper','paper_cups','tetra_pak', 'cigarette_butt','plastic_bags','plastic_bottles','plastic_containers','plastic_cups']
    
    
    inBase = "Documents/GitHub/trashnet/data/dataset-resized"
    inDataPath = os.path.join(inBase)
    outBase = "Documents/GitHub/trashnet/data/dataset-trashysplit"
