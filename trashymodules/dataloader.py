...
def split_train_val_test():
    ...
    waste_types = ['cardboard','glass','electrical cables','electronic chips','laptops','small appliances','smartphones','gloves','masks','medicines','syringe','beverage cans','construction scrap','metal containers','other metal objects','spray cans','news paper','paper','paper cups','tetra pak', 'cigarette butt','plastic bags','plastic bottles','plastic containers','plastic cups']
    
    
    inBase = "Documents/GitHub/trashnet/data/dataset-resized"
    inDataPath = os.path.join(inBase)
    outBase = "../TrashBox-VGG19_model/trashyDataset"
